...
%genomic 
data sets.
%, in collaboration with cancer biologists and medical doctors. 
...
one of the main programming languages used for data science. I am
interested to become the next Assistant Professor of Computer Science at
University of California, Santa Cruz.

Santa Cruz excites me for two reasons. First, my research project is
focused on statistical machine learning models for genomic data sets,
so I know there will be many interesting collaborators at Santa Cruz,
especially in Jim Kent's Genome Informatics group. Second, I am originally
from Southern California (Tustin, in Orange County), I have visited
Santa Cruz many times, and I would love to move back to California.
...
%For several more specific ideas for future research projects, please see my Research Statement.
...
collaborators (Guillaume Bourque, Paul Fearnhead, Daniela Witten). 
% I have also provided three supplemental references: Daniela
