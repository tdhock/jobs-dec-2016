...
% My research contributions are very compatible with your desire to
% develop new statistical methods and algorithms for big biomedical
% data. 
...
% with high throughput sequencing data and time series analysis (in
% particular optimal changepoint detection algorithms). 
%Finally, most
Most of
