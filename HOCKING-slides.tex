...
\begin{frame}
  \frametitle{Unsupervised algorithms inaccurate for 
    complex patterns}
  \begin{itemize}
  \item Domain expert (biologist?) with prior knowledge manually writes an
...
\begin{frame}
  \frametitle{Main questions in machine learning research}
  \begin{itemize}
  \item How to learn $f$ which is as accurate as possible?
%\\ Mathematical optimization.
  \item How many labeled examples are required?
    %Statistics.\\
  \item Is $f$ a black box, or can we interpret the model to
    understand how it makes a decision?
